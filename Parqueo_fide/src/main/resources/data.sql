...
-- Espacios del Parqueo B (id_parqueo = 2)
INSERT INTO espacio (id, codigo, disponible, parqueo_id)
VALUES 
  (6, 'A1', true, 2),
  (7, 'A2', true, 2),
